...
**Semantic & Accent**
- Cal.com is deliberately colorless for brand elements — "a grayscale brand to emphasise boldness and professionalism"
...
| Level 2 (Ring + Soft) | `rgba(19,19,22,0.7) 0px 1px 5px -4px, rgba(34,42,53,0.08) 0px 0px 0px 1px, rgba(34,42,53,0.05) 0px 4px 8px 0px` | **Cards, containers — the workhorse shadow** |
...
**Shadow Philosophy:**
- Ring borders: `0px 0px 0px 1px` shadows act as borders, avoiding CSS `border` entirely. Creates hairline containment without affecting layout.
...
## Trade-offs
- **Pros:** Extremely clean, professional, timeless. Grayscale scales to any product. Shadow system is sophisticated and copy-pasteable. Cal Sans + Inter pairing is versatile.
- **Cons:** Zero color personality — can feel cold or clinical. Requires high-quality product screenshots to work (no decorative fallback). Cal Sans is display-only — adds font management complexity. Grayscale can feel "unfinished" to stakeholders expecting brand color.

---

## What NOT to Copy
- **Don't use Cal Sans for body text or text below 16px** — it wasn't designed for extended reading.
- **Don't add brand colors** — Cal.com is intentionally grayscale, color is reserved for links and UI states only.
- **Don't use CSS borders when shadows can achieve the same containment** — the ring-shadow technique is the system's approach.
- **Don't apply negative letter-spacing to Cal Sans at small sizes** — it needs positive spacing (+0.2px) below 24px.
- **Don't create heavy, dark shadows** — Cal.com's shadows are subtle (5% opacity diffused) with sharp contact edges.
- **Don't use illustrations, abstract graphics, or decorative elements** — the visual language is typography + product UI only.
- **Don't mix Cal Sans weights** — the font is designed for weight 600, other weights break the intended character.
- **Don't reduce section spacing below 48px** — the generous whitespace is core to the premium monochrome aesthetic.
...
- Check that the palette is purely grayscale — if you see brand colors, remove them.
- Ensure card elevation uses the multi-layered shadow stack, not CSS borders.
- Confirm section spacing is generous (80px+) — if sections feel cramped, add more space.
- The overall tone should feel like a clean, professional scheduling tool — monochrome confidence without any decorative flourishes.